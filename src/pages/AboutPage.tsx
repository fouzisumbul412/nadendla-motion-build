...
const timeline = [
  { year: "2010", title: "Founded", description: "Nadendla Constructions established with a vision to transform the construction industry." },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        <PageHero 
          title="About Us" 
          subtitle="Building landmarks and transforming communities since 2010"
        />
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                  Founded in 2010, Nadendla Constructions has grown from a small construction 
